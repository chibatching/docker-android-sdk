...
RUN echo y | android update sdk --no-ui --all --filter "platform-tools,build-tools-24.0.2,build-tools-23.0.3,android-23"
# Install Android N SDK
RUN echo y | android update sdk --no-ui --all --filter "android-24"
# Android Support Repository 36, Google Repository 32
